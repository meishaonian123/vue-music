      ...
      <div class="normal-player" v-show="fullScreen">  
        ...
        <div class="bottom">
          ...
          <div class="progress-wrapper">
            ...
            <span class="time time-r">{{retTime}}</span>
          </div>
          <div class="operators">
...
export default {
   ...
   mounted() {
    ...
    // this.currentSong.url = `http://isure.stream.qqmusic.qq.com/C400001BzJUE2s3pLk.m4a?guid=7800219300&vkey=732721A8E3C16DA92B15FCAC2F1004DA8E263229CE7E2C4342E3691211B794B91EFD256422D95A8B396F774F20FAA7D11BD3932DD04BBAEF&uin=0&fromtag=66`
   },
   computed: {
     ...mapGetters([
       'currentIndex',
     ...
     retTime() {
       let ret = this.currentSong.duration - this.currentTime
       if (ret < 0) {
         ret = 0
       }
